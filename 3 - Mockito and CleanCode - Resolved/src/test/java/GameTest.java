...
public class GameTest {
    ...
    public void when_writeQuit_then_exitGame() {
        ...
        Assert.assertTrue(out.toString().contains("Let's play Rock"));//assertTrue compara el texto de la consola con un contenido que le pasemos
    }

    @Test
    public void when_chooseRock_then_beatsScissors() {//piedra le gana a tijera
    ...
    @Test
    public void when_chooseScissors_then_beatsPaper() {//tijera gana a papel
